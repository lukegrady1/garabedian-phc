  ...
  return (
    <>
      ...
      <header className="bg-primary text-white">
        <div className="max-w-[1200px] mx-auto px-[40px] py-16">
          <h1 className="font-headline text-[80px] leading-[1] tracking-[-0.02em] font-extrabold uppercase">
            Contact Our Team
          </h1>
          <p className="font-body text-[18px] leading-[1.6] max-w-2xl mt-4 opacity-90">
      ...
      <section className="max-w-[1200px] mx-auto px-[40px] py-[80px] grid grid-cols-1 md:grid-cols-12 gap-[24px] items-start">
        {/* Left Column: Form */}
        ...
        <FadeIn className="md:col-span-5 space-y-[24px]" delay={0.15}>
          {/* Info Panel */}
          <div className="bg-primary text-white p-10 border-2 border-primary">
            <h2 className="font-headline text-[24px] leading-[1.2] font-semibold uppercase border-b-2 border-white/30 pb-4 mb-6">
              Contact Details
            </h2>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="font-headline text-[24px] leading-[1.2] font-semibold hover:underline"
                  >
                    {siteConfig.phone}
                  </a>
                </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="bg-white/10 p-4 w-full">
                  ...
                  <a
                    ...
                    className="font-headline text-[24px] leading-[1.2] font-semibold text-white hover:underline"
                  >
      ...
      <FadeIn>
        <section className="w-full bg-[#b3dcf1] py-12 border-t-2 border-b-2 border-primary">
          <div className="max-w-[1200px] mx-auto px-[40px] flex flex-col md:flex-row justify-between items-center gap-[24px]">
            <div className="flex items-center gap-4">
              <ShieldCheck className="w-9 h-9 text-primary" />
              <span className="font-headline text-[24px] leading-[1.2] font-semibold uppercase text-primary">
                Licensed & Insured
              </span>
            </div>
            <div className="flex items-center gap-4">
